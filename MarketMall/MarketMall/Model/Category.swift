...
//    let menClothing = Category(_name: "Men's Clothing & Accessories", _imageName: "manCloth")
...
//
//    let arrayOfCategory = [womenClothing, footWaer, electronics, menClothing, health, baby, home, car, luggage, jewelery, hobby, pet, industry, garden, camera]
//
